...
品牌在自然页头，作品时间轴标题与年份在上。日期位于1px轨道上方，产品块位于下方。产品按 `date` 升序、同日维持注册顺序；列宽420/380/340/290px适配现有断点。末端虚线对应「未完待续」。每件作品一个原生链接，布局预览展示三张真实图鉴，灵感使用真实动态媒体。时间轴已支持独立站点外链入口及收录日期标记。
