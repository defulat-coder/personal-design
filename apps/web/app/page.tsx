...
export default function HomePage() {
  ...
  const musePreviews: { src: string; alt: string; videoSrc?: string }[] = posts.flatMap(post => {
  ...
  if (motionPost && motionMedia?.src) musePreviews.unshift({ src: motionMedia.thumb ?? motionMedia.poster ?? '', alt: motionPost.title, videoSrc: videoPreviewUrl(motionPost, motionMedia) ?? motionMedia.src });
