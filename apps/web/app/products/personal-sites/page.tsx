...
import { WhirlIntro, WhirlText } from '@/components/whirl-text';
...
export default function PersonalSitesPage() {
  return <main className={styles.page}>
    ...
    <header className={styles.header}>
      <div><p><WhirlText>一份持续更新的个人工程档案。</WhirlText></p></div>
    ...
    <p className={styles.description}><WhirlText>在这里记录工程经历，也整理每天读到的动态、值得回看的内容和持续关注的开源项目。从一条摘要进入完整阅读，再回到原始来源。</WhirlText></p>
    </WhirlIntro>
