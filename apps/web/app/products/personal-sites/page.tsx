...
import { personalSite, websiteUrl, promoUrl, promoPosterUrl } from '@personal-design/personal-sites';
...
export default function PersonalSitesPage() {
  return <main className={styles.page}>
    ...
    <header className={styles.header}>
      <div><h1>{personalSite.name}</h1><p>一份持续更新的个人工程档案。</p></div>
    ...
    <p className={styles.description}>在这里记录工程经历，也整理每天读到的动态、值得回看的内容和持续关注的开源项目。从一条摘要进入完整阅读，再回到原始来源。</p>
